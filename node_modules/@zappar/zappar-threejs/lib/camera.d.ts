...
import { CameraSource } from './defaultpipeline.js';
...
export declare enum CameraProfile {
    Default = 0,
    High = 1
}
/**
 ...
 */
export type Options = Zappar.Pipeline | (Partial<{
...
export declare class Camera extends THREE.Camera {
     ...
     */
    onCameraPoseUpdate: Zappar.Event;
    /**
    ...
    get profile(): CameraProfile;
    set profile(value: CameraProfile);
    /**
