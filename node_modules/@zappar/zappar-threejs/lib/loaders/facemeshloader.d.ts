...
export declare class FaceMeshLoader extends THREE.Loader {
     ...
     * New THREE.js style signature (required by Loader base class)
     */
    load(url: string, onLoad: (data: FaceMesh) => void, onProgress?: (event: ProgressEvent<EventTarget>) => void, onError?: (err: unknown) => void): void;
    /**
     * Loads the data for a face mesh.
     * Original backward-compatible signature
