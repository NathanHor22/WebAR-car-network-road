...
export var CameraProfile;
(function (CameraProfile) {
    CameraProfile[CameraProfile["Default"] = 0] = "Default";
    CameraProfile[CameraProfile["High"] = 1] = "High";
...
export class Camera extends THREE.Camera {
    ...
    get near() {
        var _a;
        return (_a = this.zNear) !== null && _a !== void 0 ? _a : 0.001;
    }
    get profile() {
    ...
    set profile(value) {
        this._profile = value;
        if (this.rearCameraSource instanceof CameraSource) {
            this.rearCameraSource.profile = value === CameraProfile.High ? camera_profile_t.HIGH : camera_profile_t.DEFAULT;
        }
        if (this.userCameraSource instanceof CameraSource) {
            this.userCameraSource.profile = value === CameraProfile.High ? camera_profile_t.HIGH : camera_profile_t.DEFAULT;
        }
    }
    /**
    ...
    constructor(opts) {
        super();
        /**
         * Emitted when the camera has been updated with the latest tracking pose.
         */
        this.onCameraPoseUpdate = new Zappar.Event();
        /**
        ...
        this.renderWidth = 0;
        this.renderHeight = 0;
        this._profile = CameraProfile.Default;
    ...
    cameraSourceFromOpts(cameraSource, frontFacing = false) {
        return cameraSource instanceof Element ? new Zappar.HTMLElementSource(this.pipeline, cameraSource) : new CameraSource(cameraSource || Zappar.cameraDefaultDeviceID(frontFacing), this.pipeline);
    }
    /**
    ...
    handleColorSpace(renderer) {
        ...
        if ((renderer === null || renderer === void 0 ? void 0 : renderer.outputColorSpace) && (THREE === null || THREE === void 0 ? void 0 : THREE.SRGBColorSpace)) {
            decoderRequired = (renderer === null || renderer === void 0 ? void 0 : renderer.outputColorSpace) === (THREE === null || THREE === void 0 ? void 0 : THREE.SRGBColorSpace);
        }
        if (!decoderRequired) {
            this.backgroundTexture.colorSpace = renderer.outputColorSpace;
        }
    ...
    updateFrame(renderer) {
        ...
        this.onCameraPoseUpdate.emit();
    }
    // eslint-disable-next-line no-underscore-dangle
    _updateProjectionMatrix() {
        // Get the projection matrix for the camera from the Zappar library
        const projection = this.pipeline.projectionMatrix(this.renderWidth, this.renderHeight, this.zNear, this.zFar);
